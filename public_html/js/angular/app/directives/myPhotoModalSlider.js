angular.module('HorizontesApp').directive('myPhotoModalSlider',function($document, $window){
    return {
        restrict: 'E',
        scope: {
            basePath: '@',
        ...
        templateUrl: 'js/angular/app/directives/templates/myPhotoModalSlider.html'
    };
});
